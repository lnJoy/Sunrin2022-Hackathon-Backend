...
export class CreateTable1657899978936 implements MigrationInterface {
    name = 'CreateTable1657899978936'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "road_cat_post" DROP CONSTRAINT "FK_24e8376d0e2c371c95423c131ff"`);
        await queryRunner.query(`ALTER TABLE "road_cat_post" DROP COLUMN "photo"`);
        ...
        await queryRunner.query(`ALTER TABLE "road_cat_post" ADD "photo" text`);
        ...
        await queryRunner.query(`ALTER TABLE "road_cat_post" ADD CONSTRAINT "FK_24e8376d0e2c371c95423c131ff" FOREIGN KEY ("locationId") REFERENCES "location"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
